...
<body style="overflow-x:hidden" class="d-flex flex-column min-vh-100 bg-light">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 ms-4 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link {{ $title == 'Home' ? 'active fw-bold text-primary' : '' }} " aria-current="page"
              href="{{ url('') }}">Home</a>
          </li>
          <li class="nav-item">
  ...
  <footer class="bg-white text-center text-white mt-auto">
    ...
    <div class="text-center p-3">
      <p style="font-weight: bold; color: black">Contact us :</p>
      <p style=" color: black">admin@mengheal.co.id</p>
      <p style="font-weight: bold; color: black">© 2022 Copyright:</p>
      <h2> <a href="{{ url('') }}" class="company-name"> Mengheal</a></h2>
    </div>
    <!-- Copyright -->
  </footer>
