...
<div class="wrapper">
    ...
    <section id="courses">
        <div class="kolom">
            ...
            <p class="konten-text">Halo guys, kalian lesu hari ini? Ayoo baca kata-kata luar biasa dari ahli-ahli kami.
    ...
    <section id="home">
        ...
        <div class="kolom">
            ...
            <p class="konten-text">Halo sahabat syurga, kalian ingin dapat motivasi tapi mager membaca? Web kami menyediakan
